...
def about():
	 return render_template('www.raja.com')
...
def AddEmp():
    ...
    try:
        ...
        s3 = boto3.resource('s3')
         ...
         try:
            ...
            try:
                dynamodb_client = boto3.client('dynamodb', region_name='ap-south-1b')
    ...
    return render_template('databaseOutput.html', name=emp_name)
...
def FetchData():
    ...
    try:
        ...
        try:
            ...
            program_msg = "Flask could not update DynamoDB table with S3 object URL"
            return render_template('database.html', errmsg1=program_msg, errmsg2=e)
